...
return [
    ...
    */
    ...
    'bladeExtended'                 => env('ROLES_GUI_BLADE_EXTENDED', 'admin.layouts.master'),

    // Blade Extension Placement
    'bladePlacement'                => env('ROLES_GUI_BLADE_PLACEMENT', 'yield'),
    'bladePlacementCss'             => env('ROLES_GUI_BLADE_PLACEMENT_CSS', 'style'),
    'bladePlacementJs'              => env('ROLES_GUI_BLADE_PLACEMENT_JS', 'js'),
